...
import { PlayerStatsComponent, ConnectionsListComponent, UpgradeOffersComponent,
	...
	DeadNodesComponent, BuildingsComponent, ToolsComponent
...
async function startGame() {
	...
	const toolsComponent = new ToolsComponent(gameClient);
...
if (IS_DEBUG) startGame();
else {
	const landingModal = document.getElementById('landing-modal');
	const startGameButton = document.getElementById('start-game-btn');
	startGameButton.onclick = () => { landingModal.classList.remove('visible'); startGame() };
}